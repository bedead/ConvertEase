...
export default function PdfToWord() {
    ...
    const handleConvert = async () => {
        ...
        try {
            const res = await fetch('/api/pdf-to-html', {
                method: 'POST',
                body: formData,
            });
    ...
    return (
        <div className="container mx-auto p-4">
            <h1 className="text-3xl font-bold mb-6">Convert PDF to HTML</h1>
            <div className="mb-4">
            ...
            {convertedContent && (
                <div className="mt-6">
                    <h2 className="text-xl font-semibold mb-2">Converted HTML Content</h2>
